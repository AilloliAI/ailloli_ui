...
layout(location = 7) in float in_clip_radius_px;
layout(location = 8) in float in_clip_mode;
...
layout(location = 6) out float v_clip_radius_px;
layout(location = 7) out float v_clip_mode;
