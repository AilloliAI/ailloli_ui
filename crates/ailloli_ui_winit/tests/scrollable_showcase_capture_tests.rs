//! Local-only scrollable showcase visual tests for the scrollable showcase pages.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test scrollable_showcase_capture_tests -- --ignored --nocapture
//! ```
...
fn run_showcase_captures(elements: &[ElementCapture]) -> Vec<(String, CapturedFrame)> {
    ...
    App::new()
        .window(
            Window::new("white")
                .title_text("ui_bundle_scrollable_showcase_white")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("default")
                .title_text("ui_bundle_scrollable_showcase_default")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&white.frame, "ui_bundle_scrollable_showcase_white_full.png");
    std::fs::write(
        out_dir.join("ui_bundle_scrollable_showcase_white_full.png"),
    ...
    assert_non_empty_frame(
        &default.frame,
        "ui_bundle_scrollable_showcase_default_full.png",
    );
    std::fs::write(
        out_dir.join("ui_bundle_scrollable_showcase_default_full.png"),
    ...
    let mut frames = vec![
        (
            "ui_bundle_scrollable_showcase_white_full.png".to_string(),
            white.frame,
        ),
        (
            "ui_bundle_scrollable_showcase_default_full.png".to_string(),
            default.frame,
        ),
    ];
...
#[test]
#[ignore]
fn ui_bundle_scrollable_showcase_showcases_capture() {
    let frames = run_showcase_captures(&[
        ElementCapture {
            window: "white",
            key: "section-buttons",
            file: "ui_bundle_scrollable_showcase_white_buttons.png",
        },
        ElementCapture {
            window: "default",
            key: "section-buttons",
            file: "ui_bundle_scrollable_showcase_default_buttons.png",
        },
        ElementCapture {
            window: "default",
            key: "section-text-inputs",
            file: "ui_bundle_scrollable_showcase_default_text_inputs.png",
        },
        ElementCapture {
            window: "default",
            key: "section-editor",
            file: "ui_bundle_scrollable_showcase_default_editor_scroll.png",
        },
        ElementCapture {
            window: "default",
            key: "section-extension-points",
            file: "ui_bundle_scrollable_showcase_default_extension_points.png",
        },
    ]);
