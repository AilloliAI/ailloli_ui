//! Local-only navigation and lists visual tests for Sidebar, NavItem, ListView and DisclosureRow.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test navigation_lists_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_navigation_lists_navigation_lists_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_navigation_lists_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_navigation_lists_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&default, "ui_bundle_navigation_lists_navigation_lists.png");
    assert_non_empty_frame(
        &white,
        "ui_bundle_navigation_lists_navigation_lists_white.png",
    );
    assert_non_monochrome(&default, "ui_bundle_navigation_lists_navigation_lists.png");
    assert_non_monochrome(
        &white,
        "ui_bundle_navigation_lists_navigation_lists_white.png",
    );
    write_capture("ui_bundle_navigation_lists_navigation_lists.png", &default);
    write_capture(
        "ui_bundle_navigation_lists_navigation_lists_white.png",
        &white,
    );
