//! Local-only Phase 48 visual tests for Card, Avatar, StatusIndicator and Divider.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test ui_bundle_phase48_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_phase48_cards_avatar_status_divider_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_phase48_default")
                .no_chrome()
                .size(1280.0, 900.0)
                .content(|| {
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_phase48_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(
        &default,
        "ui_bundle_phase48_cards_avatar_status_divider.png",
    );
    assert_non_empty_frame(
        &white,
        "ui_bundle_phase48_cards_avatar_status_divider_white.png",
    );
