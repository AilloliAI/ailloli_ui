//! Local-only Badge, Chip and Tag visual tests for Badge / Chip / Tag.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test badge_chip_tag_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_badge_chip_tag_badges_chips_tags_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_badge_chip_tag_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_badge_chip_tag_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&default, "ui_bundle_badge_chip_tag_badges_chips_tags.png");
    assert_non_empty_frame(
        &white,
        "ui_bundle_badge_chip_tag_badges_chips_tags_white.png",
    );
    write_capture("ui_bundle_badge_chip_tag_badges_chips_tags.png", &default);
    write_capture(
        "ui_bundle_badge_chip_tag_badges_chips_tags_white.png",
        &white,
    );
