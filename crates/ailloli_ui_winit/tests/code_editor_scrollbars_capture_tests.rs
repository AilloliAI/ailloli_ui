//! Local-only CodeEditor scrollbars visual test for CodeEditor scrollbars.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test code_editor_scrollbars_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_code_editor_scrollbars_code_editor_scrollbars_capture() {
    let cap = CaptureHandle::new();
    cap.set_exit_after_all_captures(true);
    let capture_id = cap.request_element(
        "code-editor-scrollbars-code-editor",
        "code-editor-scrollbars-code-editor",
    );

    App::new()
        .window(
            Window::new("code-editor-scrollbars-code-editor")
                .title_text("ui_bundle_code_editor_scrollbars_code_editor_scrollbars")
                .no_chrome()
                .size(980.0, 520.0)
    ...
    assert_code_editor_scrollbar_frame(
        &frame,
        "ui_bundle_code_editor_scrollbars_code_editor_scrollbars.png",
    );
    write_capture(
        "ui_bundle_code_editor_scrollbars_code_editor_scrollbars.png",
        &frame,
...
fn code_editor_scrollbar_showcase() -> impl IntoView<()> {
    ...
    Container::new()
        ...
        .key("code-editor-scrollbars-code-editor")
}
