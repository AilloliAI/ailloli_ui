//! Local-only Accordion and TreeView visual tests for Accordion and TreeView.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test accordion_tree_view_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_accordion_tree_view_accordion_tree_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_accordion_tree_view_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_accordion_tree_view_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&default, "ui_bundle_accordion_tree_view_accordion_tree.png");
    assert_non_empty_frame(
        &white,
        "ui_bundle_accordion_tree_view_accordion_tree_white.png",
    );
    assert_non_monochrome(&default, "ui_bundle_accordion_tree_view_accordion_tree.png");
    assert_non_monochrome(
        &white,
        "ui_bundle_accordion_tree_view_accordion_tree_white.png",
    );
    write_capture("ui_bundle_accordion_tree_view_accordion_tree.png", &default);
    write_capture(
        "ui_bundle_accordion_tree_view_accordion_tree_white.png",
        &white,
    );
