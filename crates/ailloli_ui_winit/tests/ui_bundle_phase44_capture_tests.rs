//! Local-only Phase 44 visual tests for Slider and RangeSlider.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test ui_bundle_phase44_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_phase44_slider_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_phase44_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_phase44_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&default, "ui_bundle_phase44_slider.png");
    assert_non_empty_frame(&white, "ui_bundle_phase44_slider_white.png");
    assert_non_monochrome(&default, "ui_bundle_phase44_slider.png");
    assert_non_monochrome(&white, "ui_bundle_phase44_slider_white.png");
    write_capture("ui_bundle_phase44_slider.png", &default);
    write_capture("ui_bundle_phase44_slider_white.png", &white);
