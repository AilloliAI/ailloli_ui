//! Local-only FileExplorer visual tests for FileExplorer.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test file_explorer_capture_tests -- --ignored --nocapture
//! ```
...
fn assert_file_explorer_file_explorer_frame(frame: &CapturedFrame, name: &str) {
...
#[test]
#[ignore]
fn ui_bundle_file_explorer_file_explorer_capture() {
    let cap = CaptureHandle::new();
    cap.set_exit_after_all_captures(true);
    let file_explorer_id =
        cap.request_element("file_explorer-file-explorer", "file_explorer-file-explorer");

    App::new()
        .window(
            Window::new("file_explorer-file-explorer")
                .title_text("ui_bundle_file_explorer_file_explorer")
                .no_chrome()
                .size(640.0, 420.0)
    ...
    assert_file_explorer_file_explorer_frame(&frame, "ui_bundle_file_explorer_file_explorer.png");
    write_capture("ui_bundle_file_explorer_file_explorer.png", &frame);
}

#[test]
#[ignore]
fn ui_bundle_file_explorer_file_explorer_path_api_capture() {
    let cap = CaptureHandle::new();
    cap.set_exit_after_all_captures(true);
    let file_explorer_id = cap.request_element(
        "file_explorer-file-explorer-path-api",
        "file_explorer-file-explorer-path-api",
    );

    App::new()
        .window(
            Window::new("file_explorer-file-explorer-path-api")
                .title_text("ui_bundle_file_explorer_file_explorer_path_api")
                .no_chrome()
                .size(720.0, 760.0)
    ...
    assert_file_explorer_file_explorer_frame(
        &frame,
        "ui_bundle_file_explorer_file_explorer_path_api.png",
    );
    write_capture("ui_bundle_file_explorer_file_explorer_path_api.png", &frame);
}

#[test]
#[ignore]
fn ui_bundle_file_explorer_file_explorer_scrollable_capture() {
    let cap = CaptureHandle::new();
    cap.set_exit_after_all_captures(true);
    let file_explorer_id = cap.request_element(
        "file_explorer-file-explorer-scrollable",
        "file_explorer-file-explorer-scrollable",
    );

    App::new()
        .window(
            Window::new("file_explorer-file-explorer-scrollable")
                .title_text("ui_bundle_file_explorer_file_explorer_scrollable")
                .no_chrome()
                .size(520.0, 360.0)
    ...
    assert_file_explorer_file_explorer_frame(
        &frame,
        "ui_bundle_file_explorer_file_explorer_scrollable.png",
    );
    write_capture(
        "ui_bundle_file_explorer_file_explorer_scrollable.png",
        &frame,
...
fn file_explorer_showcase() -> impl IntoView<()> {
    ...
    Container::new()
        ...
        .key("file_explorer-file-explorer")
}
...
fn file_explorer_path_api_showcase() -> impl IntoView<()> {
    ...
    Container::new()
        ...
        .key("file_explorer-file-explorer-path-api")
}
...
fn file_explorer_scrollable_showcase() -> impl IntoView<()> {
    ...
    Container::new()
        ...
        .key("file_explorer-file-explorer-scrollable")
}
