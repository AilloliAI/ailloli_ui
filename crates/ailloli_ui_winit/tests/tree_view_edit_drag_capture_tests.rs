//! Local-only TreeView edit and drag visual tests for TreeView edit/drag states.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test tree_view_edit_drag_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_tree_view_edit_drag_tree_edit_drag_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_tree_view_edit_drag_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_tree_view_edit_drag_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&default, "ui_bundle_tree_view_edit_drag_tree_edit_drag.png");
    assert_non_empty_frame(
        &white,
        "ui_bundle_tree_view_edit_drag_tree_edit_drag_white.png",
    );
    assert_non_monochrome(&default, "ui_bundle_tree_view_edit_drag_tree_edit_drag.png");
    assert_non_monochrome(
        &white,
        "ui_bundle_tree_view_edit_drag_tree_edit_drag_white.png",
    );
    write_capture("ui_bundle_tree_view_edit_drag_tree_edit_drag.png", &default);
    write_capture(
        "ui_bundle_tree_view_edit_drag_tree_edit_drag_white.png",
        &white,
    );
