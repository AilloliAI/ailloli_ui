//! Local-only TableView visual tests for TableView.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test table_view_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_table_view_table_view_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_table_view_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_table_view_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&default, "ui_bundle_table_view_table_view.png");
    assert_non_empty_frame(&white, "ui_bundle_table_view_table_view_white.png");
    assert_non_monochrome(&default, "ui_bundle_table_view_table_view.png");
    assert_non_monochrome(&white, "ui_bundle_table_view_table_view_white.png");
    write_capture("ui_bundle_table_view_table_view.png", &default);
    write_capture("ui_bundle_table_view_table_view_white.png", &white);
