...
fn scenario_a(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_multilayer_compositing_A_two_layers_no_clip.png", png);
    }
...
fn scenario_b(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_multilayer_compositing_B_layer2_rect_clip.png", png);
    }
...
fn scenario_c(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact(
            "diag_multilayer_compositing_C_root_round_nested_rect_post.png",
            png,
        );
    }
...
fn scenario_d(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_multilayer_compositing_D_overflow_clipped.png", png);
    }
...
#[test]
#[ignore]
fn multilayer_compositing_multilayer_visual_regressions() {
    ...
    assert!(
        ...
        "multilayer_compositing multi-layer scenarios failed:\n  - {}",
