//! Local-only ComboBox and Autocomplete visual tests for ComboBox and Autocomplete.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test combo_box_autocomplete_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_combo_box_autocomplete_combobox_autocomplete_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_combo_box_autocomplete_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_combo_box_autocomplete_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(
        &default,
        "ui_bundle_combo_box_autocomplete_combobox_autocomplete.png",
    );
    assert_non_empty_frame(
        &white,
        "ui_bundle_combo_box_autocomplete_combobox_autocomplete_white.png",
    );
