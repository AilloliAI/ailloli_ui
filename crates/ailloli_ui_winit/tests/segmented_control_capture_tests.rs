//! Local-only SegmentedControl visual tests for SegmentedControl.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test segmented_control_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_segmented_control_segmented_control_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_segmented_control_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_segmented_control_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(
        &default,
        "ui_bundle_segmented_control_segmented_control.png",
    );
    assert_non_empty_frame(
        &white,
        "ui_bundle_segmented_control_segmented_control_white.png",
    );
