...
fn scenario_x_backdrop_clipped(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_backdrop_filter_X_backdrop_clipped.png", png);
    }
...
fn scenario_y_backdrop_opacity(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    let captured = renderer
        ...
        .expect("capture Y");
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_backdrop_filter_Y_backdrop_opacity.png", png);
    }
...
fn scenario_z_backdrop_and_content_blur(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    let captured = renderer
        ...
        .expect("capture Z");
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_backdrop_filter_Z_backdrop_content_blur.png", png);
    }
...
fn scenario_aa_budget_skip(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    let captured = renderer
        ...
        .expect("capture AA");
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_backdrop_filter_AA_budget_skip.png", png);
    }
...
fn scenario_ab_nested_no_backdrop(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    let captured = renderer
        ...
        .expect("capture AB");
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_backdrop_filter_AB_nested_no_backdrop.png", png);
    }
...
#[test]
#[ignore]
fn backdrop_filter_backdrop_filter_visual_regressions() {
    ...
    assert!(
        ...
        "backdrop_filter backdrop filter scenarios failed:\n  - {}",
