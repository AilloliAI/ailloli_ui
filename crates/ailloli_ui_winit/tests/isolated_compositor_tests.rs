...
fn scenario_h_opacity_clipped(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_isolated_compositor_H_opacity_clipped.png", png);
    }
...
fn scenario_i_blur(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    let captured = renderer
        ...
        .expect("capture I");
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_isolated_compositor_I_blur.png", png);
    }
...
fn scenario_j_stencil_round(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    let captured = renderer
        ...
        .expect("capture J");
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_isolated_compositor_J_stencil_round.png", png);
    }
...
fn scenario_k_z_sandwich(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    let captured = renderer
        ...
        .expect("capture K");
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_isolated_compositor_K_z_sandwich.png", png);
    }
...
fn scenario_l_two_siblings(renderer: &mut Renderer, rep: &mut ScenarioReport) {
    ...
    let captured = renderer
        ...
        .expect("capture L");
    if let Some(png) = captured.png_data.as_ref() {
        write_artifact("diag_isolated_compositor_L_two_siblings.png", png);
    }
...
#[test]
#[ignore]
fn isolated_compositor_isolated_compositor_visual_regressions() {
    ...
    assert!(
        ...
        "isolated_compositor isolated compositor scenarios failed:\n  - {}",
