//! Local-only Phase 42 visual tests for RadioGroup.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test ui_bundle_phase42_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_phase42_radio_group_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_phase42_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_phase42_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&default, "ui_bundle_phase42_radio_group.png");
    assert_non_empty_frame(&white, "ui_bundle_phase42_radio_group_white.png");
    assert_non_monochrome(&default, "ui_bundle_phase42_radio_group.png");
    assert_non_monochrome(&white, "ui_bundle_phase42_radio_group_white.png");
    write_capture("ui_bundle_phase42_radio_group.png", &default);
    write_capture("ui_bundle_phase42_radio_group_white.png", &white);
