//! Local-only charts visual tests for simple charts.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test charts_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_charts_charts_capture() {
    ...
    App::new()
        .window(
            Window::new("charts-default")
                .title_text("ui_bundle_charts_charts_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("charts-white")
                .title_text("ui_bundle_charts_charts_white")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("charts-line-debug")
                .title_text("ui_bundle_charts_line_chart_debug")
                .no_chrome()
                .size(520.0, 360.0)
    ...
    assert_charts_frame(&default, "ui_bundle_charts_charts.png", true);
    assert_charts_frame(&white, "ui_bundle_charts_charts_white.png", false);
    assert_line_chart_debug_frame(&line_debug, "ui_bundle_charts_line_chart_debug.png");
    write_capture("ui_bundle_charts_charts.png", &default);
    write_capture("ui_bundle_charts_charts_white.png", &white);
    write_capture("ui_bundle_charts_line_chart_debug.png", &line_debug);
}

/// Verifies chart palette colors and contrast for the selected theme.
fn assert_charts_frame(frame: &CapturedFrame, filename: &str, dark: bool) {
