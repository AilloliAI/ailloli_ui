//! Local-only Phase 53 visual tests for pickers and upload.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test ui_bundle_phase53_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_phase53_pickers_upload_capture() {
    ...
    App::new()
        .window(
            Window::new("pickers-default")
                .title_text("ui_bundle_phase53_pickers_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("pickers-white")
                .title_text("ui_bundle_phase53_pickers_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_phase53_frame(&default, "ui_bundle_phase53_pickers_upload.png", true);
    assert_phase53_frame(&white, "ui_bundle_phase53_pickers_upload_white.png", false);
    write_capture("ui_bundle_phase53_pickers_upload.png", &default);
    write_capture("ui_bundle_phase53_pickers_upload_white.png", &white);
}

fn assert_phase53_frame(frame: &CapturedFrame, filename: &str, dark: bool) {
