//! Local-only Phase 45 visual tests for ProgressBar and CircularProgress.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test ui_bundle_phase45_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_phase45_progress_capture() {
    ...
    App::new()
        .window(
            Window::new("default")
                .title_text("ui_bundle_phase45_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("white")
                .title_text("ui_bundle_phase45_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_non_empty_frame(&default, "ui_bundle_phase45_progress.png");
    assert_non_empty_frame(&white, "ui_bundle_phase45_progress_white.png");
    assert_non_monochrome(&default, "ui_bundle_phase45_progress.png");
    assert_non_monochrome(&white, "ui_bundle_phase45_progress_white.png");
    write_capture("ui_bundle_phase45_progress.png", &default);
    write_capture("ui_bundle_phase45_progress_white.png", &white);
