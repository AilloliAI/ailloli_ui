//! Local-only Phase 52 visual tests for feedback overlays.
//!
//! ```sh
//! cargo test -p ailloli_ui_winit --test ui_bundle_phase52_capture_tests -- --ignored --nocapture
//! ```
...
#[test]
#[ignore]
fn ui_bundle_phase52_feedback_and_command_palette_capture() {
    ...
    App::new()
        .window(
            Window::new("feedback-default")
                .title_text("ui_bundle_phase52_feedback_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("feedback-white")
                .title_text("ui_bundle_phase52_feedback_white")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("command-default")
                .title_text("ui_bundle_phase52_command_default")
                .no_chrome()
                .size(1280.0, 900.0)
        ...
        .window(
            Window::new("command-white")
                .title_text("ui_bundle_phase52_command_white")
                .no_chrome()
                .size(1280.0, 900.0)
    ...
    assert_phase52_frame(
        &feedback_default,
        "ui_bundle_phase52_feedback_overlays.png",
        true,
    );
    assert_phase52_frame(
        &feedback_white,
        "ui_bundle_phase52_feedback_overlays_white.png",
        false,
    );
    assert_phase52_frame(
        &command_default,
        "ui_bundle_phase52_command_palette.png",
        true,
    );
    assert_phase52_frame(
        &command_white,
        "ui_bundle_phase52_command_palette_white.png",
        false,
    );

    write_capture("ui_bundle_phase52_feedback_overlays.png", &feedback_default);
    write_capture(
        "ui_bundle_phase52_feedback_overlays_white.png",
        &feedback_white,
    );
    write_capture("ui_bundle_phase52_command_palette.png", &command_default);
    write_capture(
        "ui_bundle_phase52_command_palette_white.png",
        &command_white,
    );
...
/// Verifies Phase 52 feedback/command-palette colors for the selected palette.
fn assert_phase52_frame(frame: &CapturedFrame, name: &str, dark: bool) {
